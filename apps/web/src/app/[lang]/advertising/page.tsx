...
export default function AdvertisingPage() {
  ...
  const content = {
    kz: {
      ...
      intro: 'Біз іскерлік серіктестікке және ынтымақтастыққа ашықпыз. «Аймақ ақшамы» газеті Сатпаев қаласы мен облысында кең оқырман аудиториясына ие.',
      services: {
        title: 'Біз ұсынамыз',
        items: [
          {
            title: 'Баспа жарнамасы',
            description: 'Газетте әртүрлі форматтағы жарнамалық материалдарды орналастыру'
          },
          {
    ...
    ru: {
      ...
      intro: 'Мы открыты для делового партнерства и сотрудничества. Газета «Аймақ ақшамы» имеет широкую читательскую аудиторию в городе Сатпаев и области.',
      services: {
        title: 'Мы предлагаем',
        items: [
          {
            title: 'Печатная реклама',
            description: 'Размещение рекламных материалов различных форматов в газете'
          },
          {
