...
export default function AboutPage() {
  ...
  const content = {
    kz: {
      title: 'Біз туралы',
      subtitle: 'Сатпаев қаласының қоғамдық-саяси газеті',
      history: {
        title: 'Біздің тарих',
        content: `«Аймақ ақшамы» газеті Сатпаев қаласының негізгі ақпарат көзі болып табылады. Біз қала тұрғындарына өзекті жаңалықтар, қоғамдық оқиғалар және маңызды ақпарат ұсынамыз.

Біздің миссиямыз - объективті, сапалы және уақытылы ақпарат беру арқылы қала тұрғындарын хабардар ету және қоғамдық даму процесіне үлес қосу.`,
      },
      mission: {
        title: 'Біздің миссия',
        items: [
          'Объективті және сенімді ақпарат беру',
          'Қалалық және облыстық жаңалықтарды жария ету',
    ...
    ru: {
      title: 'О нас',
      subtitle: 'Общественно-политическая газета города Сатпаев',
      history: {
        title: 'Наша история',
        content: `Газета «Аймақ ақшамы» является основным источником информации для жителей города Сатпаев. Мы предоставляем актуальные новости, общественные события и важную информацию для горожан.

Наша миссия - информировать жителей города через объективную, качественную и своевременную информацию, а также вносить вклад в процесс общественного развития.`,
      },
      mission: {
        title: 'Наша миссия',
        items: [
          'Предоставление объективной и достоверной информации',
          'Публикация городских и областных новостей',
