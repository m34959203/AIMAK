...
export default function VacanciesPage() {
  ...
  const content = {
    kz: {
      ...
      intro: '«Аймақ ақшамы» газеті үнемі дарынды және жігерлі мамандарды іздеуде. Егер сіз журналистика саласында жұмыс істегіңіз келсе, біз сізді күтеміз!',
      positions: {
    ...
    ru: {
      ...
      intro: 'Газета «Аймақ ақшамы» постоянно находится в поиске талантливых и энергичных специалистов. Если вы хотите работать в сфере журналистики, мы ждем вас!',
      positions: {
